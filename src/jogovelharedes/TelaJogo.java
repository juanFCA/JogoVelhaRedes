...
public class TelaJogo extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jB00.setForeground(new java.awt.Color(102, 102, 102));
        jB00.setToolTipText("");
        ...
        jB01.setForeground(new java.awt.Color(102, 102, 102));
        ...
        jB02.setBackground(new java.awt.Color(255, 255, 255));
        jB02.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jB02.setForeground(new java.awt.Color(102, 102, 102));
        ...
        jB10.setForeground(new java.awt.Color(102, 102, 102));
        ...
        jB11.setForeground(new java.awt.Color(102, 102, 102));
        ...
        jB12.setForeground(new java.awt.Color(102, 102, 102));
        ...
        jB20.setForeground(new java.awt.Color(102, 102, 102));
        ...
        jB21.setBackground(new java.awt.Color(255, 255, 255));
        jB21.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jB21.setForeground(new java.awt.Color(102, 102, 102));
        ...
        jB22.setBackground(new java.awt.Color(255, 255, 255));
        jB22.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jB22.setForeground(new java.awt.Color(102, 102, 102));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(PainelBotoes, javax.swing.GroupLayout.DEFAULT_SIZE, 399, Short.MAX_VALUE))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLStatus, javax.swing.GroupLayout.DEFAULT_SIZE, 56, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaJogo dialog = new TelaJogo(new javax.swing.JFrame(), true);
...
private void ganhou(int ganhador){
    desabilitaCampos();
    if(ganhador == 1){
        jLStatus.setText("O jogador n° 1 venceu! CTRL+N para um novo jogo!");
    }
    else{
        jLStatus.setText("O jogador n° 2 venceu! CTRL+N para um novo jogo!");
    }
}
