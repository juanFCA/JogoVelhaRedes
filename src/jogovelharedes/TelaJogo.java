...
public class TelaJogo extends JFrame {
    ...
    //variaveis da rede
    private ServerSocket serverSocket = null; //responsável por esperar a conexão do cliente
    private Socket sockets = null; // cliente
    ...
    private String criptografia = "trabalhoderedes";
    ...
    public TelaJogo() {
        ...
        addWindowListener(new WindowAdapter() {
            public void windowActivated(WindowEvent event) {
                try {
                    //tenta capturar o endereço ip da maquina
    ...
    private void initComponents() {
        ...
        nick.setBackground(new java.awt.Color(102, 102, 102));
        ...
        newGame.setBackground(new java.awt.Color(102, 102, 102));
        ...
        join.setBackground(new java.awt.Color(102, 102, 102));
        ...
        jPanel2.add(sp);
        sp.setBounds(20, 30, 470, 90);

        message.setBackground(new java.awt.Color(102, 102, 102));
    ...
    private void joinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_joinActionPerformed
        try {
            ...
            sockets = new Socket(ip.getText(), Integer.parseInt(port.getText()));
                ...
                saida = new ObjectOutputStream(sockets.getOutputStream());//envia dados
            saida.flush();
            entrada = new ObjectInputStream(sockets.getInputStream());//recebe dados
            ...
            msg = (String) entrada.readObject(); //captura o nick do host
            nick1 = "" + msg;
            ...
            new TelaJogo.recebeMensagem("Recebe"); //thread para receber dados do host	
        } catch (Exception e) {
            encerrarTudo();
            executarTudo();
            try {
    ...
    private void createActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createActionPerformed
        ...
        new TelaJogo.criarThread("CreateButton"); // we need thread while we wait for client, because we don't want frozen frame
    ...
    private class criarThread implements Runnable {
        ...
        public void run() {
            try {
                ...
                serverSocket = new ServerSocket(Integer.parseInt(port.getText()));//recebe a porta para a conexao

                textArea.append("Esperando cliente...\n");
                ScrollToBottom();
                sockets = serverSocket.accept();// escuta uma conexão e aceita se alguma for encontrada
